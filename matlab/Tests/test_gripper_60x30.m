function [xstar,itotal,itotalint,f0val,f0val2,time] = test_gripper_60x30
%***************************************************************************************************************************************
%[xstar,itotal,itotalint,f0val,f0val2,time] = test_gripper_60x30
%
...
load gripper_60x30_1;
load gripper_60x30_2;
load gripper_60x30_3;
load empty_gripper_60x30;
str1 = gripper_60x30_1;
str2 = gripper_60x30_2;
str3 = gripper_60x30_3;
x0 = 0.2*ones(1800,1);
xmin = 0.001;
delta = 0.1;
frmax = 0.2;
