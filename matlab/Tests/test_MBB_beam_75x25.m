function [xstar,itotal,itotalint,f0val,f0val2,time] = test_MBB_beam_75x25
%***********************************************************************************************************************
%[xstar,itotal,itotalint,f0val,f0val2,time] = test_MBB_beam_75x25
%
%This function calls the main programs (test_structures.m and linseq_struct.m) to solve the topology
%optimization problem to find the optimum topology for a MBB beam, using 
...
rmin = 2.5;
cd ..
[xstar,itotal,itotalint,f0val,f0val2,time] = test_structures(str,x0,xmin,delta,frmax,tol,maxit,prnt,opfil,rmin);
